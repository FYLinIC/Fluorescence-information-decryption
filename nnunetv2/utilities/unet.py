...
class SAMConvUNet(nn.Module):
    def __init__(self,
        ...
        model_weight_path = os.path.join(save_path, "sam.pt")

        if not os.path.exists(model_weight_path):
            download_model(url = 'https://dl.fbaipublicfiles.com/segment_anything/sam_vit_h_4b8939.pth', destination= model_weight_path)
        ...
        sam = sam_model_registry[model_type](checkpoint=model_weight_path)
